...
const deleteUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const deleteAllCart = yield tx.cart.deleteMany({ where: { userId: id } });
        const deleteAllBooking = yield tx.booking.deleteMany({
            where: { userId: id },
        });
        const deleteAllReview = yield tx.review.deleteMany({
            where: { userId: id },
        });
        const deleteAllFeedBack = yield tx.feedback.deleteMany({
            where: { userId: id },
        });
