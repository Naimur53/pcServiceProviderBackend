import { PcService } from '@prisma/client';
        ...
        import { pcServiceFilterAbleFields } from './pcService.constant';
        const createPcService: RequestHandler = catchAsync(
          async (req: Request, res: Response) => {
            const PcServiceData = req.body;
        
            const result = await PcServiceService.createPcService(
              PcServiceData
            );
        ...
        const getAllPcService = catchAsync(
          async (req: Request, res: Response) => {
        ...
        const updatePcService: RequestHandler = catchAsync(
          async (req: Request, res: Response) => {
            ...
            const result = await PcServiceService.updatePcService(
              id,
              updateAbleData
            );
